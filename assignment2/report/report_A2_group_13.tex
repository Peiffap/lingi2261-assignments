...
\begin{table}[!hbtp]
	...
	\begin{tabular}{c@{\hspace{0.7cm}}ccc|ccc} 
		...
		\midrule
		1 & 0.00847 & 9 & 12  & 0.00866 & 9 & 67 \\
		2 & 0.0182 & 19 & 53 & 0.445 & 19 & 1364 \\
		3 & 0.0298 & 25 & 109 & 0.0179  & 25 & 171 \\
		4 & 0.0197 & 13 & 50 & 0.00935 & 13 & 126 \\
		5 & 0.00970 & 13 & 46 & 0.0100 & 13 & 81 \\
		6 & 0.0317 & 25 & 91 & 0.00974 & 25 & 160 \\
		7 & 0.0444 & 25 & 175 & 0.0225 & 25 & 238 \\
		8 & 0.102 & 33 & 298 & 0.0462 & 33 & 466 \\
		9 & 0.725 & 13 & 1568  & 1.08 & 13 & 11224 \\
		10 & 4.26 & 9 & 1380 & 58.8 & 8 & 284973 \\
		\bottomrule \\
	\end{tabular}
	\caption{Comparison of execution times for various algorithms.
		The first column contains the execution times, given with 3 significant figures in seconds; the second contains the number of moves in the solution and the third contains the number of explored nodes.}
	\label{time1}
\end{table}
...
The reason why A* consistently explores less nodes is because BFS can simply be seen as A* with heuristic \(h=0\), which is not as good as the heuristic we use.
